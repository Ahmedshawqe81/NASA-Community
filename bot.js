...
client.on('message', message => {
     ...
     let embed = new Discord.RichEmbed()
.setThumbnail(message.author.avatarURL)
.addField('        اولا ' ,' ممنوع منعا باتا التفوه بكلمات بذيئة أو تستفز أي عضوا كان ')
.addField('     ثانيا ' ,' يمنع منعا باتا كتابة التخريبية و ما يسمــى ^ سبـــام ^رجــاء ')
.addField('     ثالثا ' ,' رجــاء . عدم الإزعاج أينما كــان داخل السيرفر أو خارجه  ')
.addField('  رابعا' ,'الرجـــاء منكم عدم الإعلان عن أي مبيعات ')
.addField('    خامسا' ,' الرجـــاء عدم نشر أي أنواع من الروابط إلا في الرومـــات الخاصة بها ')
.addField('    سادسا' ,' الرجــــاء عدم النشر سواء داخل الســيرفر أو في الخاص  التحذير أولا و الطرد أخيــرا ')
.addField('    سابعا' ,' عدم طلب أي رتبة لأنه ســوف نقوم بفتح التقديمات مرة فالأسبوع! ')
.setColor('#7d2dbe')
  message.channel.sendEmbed(embed);
    }
});
